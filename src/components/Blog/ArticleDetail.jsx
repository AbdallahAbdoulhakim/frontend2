        ...
        <div class="row g-5">
          <div class="col-lg-8">
            <article class="blog-details">
              <div class="post-img">
                <img
                  src={`${process.env.PUBLIC_URL}/uploads/blog/blog-1.jpg`}
                  alt=""
                  class="img-fluid"
                />
              </div>
              ...
              <div class="content">
                ...
                <img
                  src={`${process.env.PUBLIC_URL}/uploads/blog/blog-inside-post.jpg`}
                  class="img-fluid"
                  alt=""
                />
            ...
            <div class="post-author d-flex align-items-center">
              <img
                src={`${process.env.PUBLIC_URL}/uploads/blog/blog-author.jpg`}
            ...
            <div class="comments">
              ...
              <div id="comment-1" class="comment">
                <div class="d-flex">
                  <div class="comment-img">
                    <img
                      src={`${process.env.PUBLIC_URL}/uploads/blog/comments-1.jpg`}
                      alt=""
                    />
                  </div>
                  <div>
              ...
              <div id="comment-2" class="comment">
                <div class="d-flex">
                  <div class="comment-img">
                    <img
                      src={`${process.env.PUBLIC_URL}/uploads/blog/comments-2.jpg`}
                      alt=""
                    />
                  </div>
                  <div>
                ...
                <div id="comment-reply-1" class="comment comment-reply">
                  <div class="d-flex">
                    <div class="comment-img">
                      <img
                        src={`${process.env.PUBLIC_URL}/uploads/blog/comments-3.jpg`}
                        alt=""
                      />
                    </div>
                    <div>
                  ...
                  <div id="comment-reply-2" class="comment comment-reply">
                    <div class="d-flex">
                      <div class="comment-img">
                        <img
                          src={`${process.env.PUBLIC_URL}/uploads/blog/comments-4.jpg`}
                          alt=""
                        />
                      </div>
                      <div>
              ...
              <div id="comment-3" class="comment">
                <div class="d-flex">
                  <div class="comment-img">
                    <img
                      src={`${process.env.PUBLIC_URL}/uploads/blog/comments-5.jpg`}
                      alt=""
                    />
                  </div>
                  <div>
              ...
              <div id="comment-4" class="comment">
                <div class="d-flex">
                  <div class="comment-img">
                    <img
                      src={`${process.env.PUBLIC_URL}/uploads/blog/comments-6.jpg`}
                      alt=""
                    />
                  </div>
                  <div>
              ...
              <div class="sidebar-item recent-posts">
                ...
                <div class="mt-3">
                  <div class="post-item mt-3">
                    <img
                      src={`${process.env.PUBLIC_URL}/uploads/blog/blog-recent-1.jpg`}
                      alt=""
                    />
                    <div>
                      <h4>
                  ...
                  <div class="post-item">
                    <img
                      src={`${process.env.PUBLIC_URL}/uploads/blog/blog-recent-2.jpg`}
                      alt=""
                    />
                    <div>
                      <h4>
                  ...
                  <div class="post-item">
                    <img
                      src={`${process.env.PUBLIC_URL}/uploads/blog/blog-recent-3.jpg`}
                      alt=""
                    />
                    <div>
                      <h4>
                  ...
                  <div class="post-item">
                    <img
                      src={`${process.env.PUBLIC_URL}/uploads/blog/blog-recent-4.jpg`}
                      alt=""
                    />
                    <div>
                      <h4>
                  ...
                  <div class="post-item">
                    <img
                      src={`${process.env.PUBLIC_URL}/uploads/blog/blog-recent-5.jpg`}
                      alt=""
                    />
                    <div>
                      <h4>
